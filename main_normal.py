...
# Save results to CSV
df_overall.to_csv(f"{CONFIG['normal_result_path']}overall_results.csv", index=False)
df_classwise.to_csv(f"{CONFIG['normal_result_path']}classwise_results.csv", index=False)